...
window.addEventListener("alpine:init", () => {
    Alpine.data("editRoleUser", (userId) => ({
        showAddRole: false,
        roles: [],
        rolesToAdd: [],
        ...
        async findRole(){
            ...
            try {
                ...
                const response = await axios.get(`/api/roles/${userId}/faltantes?find=${this.findRoleText}`)
        ...
        async fetchroles(){
            try {
                this.isLoadingRoles = true
                const response = await axios.get(`/api/roles/${userId}/faltantes`)
