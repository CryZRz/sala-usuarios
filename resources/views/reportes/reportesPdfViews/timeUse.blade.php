...
@section("content")
    <main class="container">
        ...
        <section>
            <span class="d-block">Reporte tiempo de uso carrera {{$career}} de {{$semester}} semestre</span>
        ...
        <section class="mt-4 w-full">
            <section>
                <h3>Total tiempo: {{$totalTime}}</h3>
            </section>
            @foreach($listReports as $report)
                <table class="w-100 fw-bold text-center mb-4" colspan="6" border="none">
